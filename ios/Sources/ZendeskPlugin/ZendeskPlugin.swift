 ...
 */
@objc(ZendeskPlugin)
public class ZendeskPlugin: CAPPlugin, CAPBridgedPlugin, UINavigationControllerDelegate {
    public let identifier = "ZendeskPlugin"
    public let jsName = "Zendesk"
    public let pluginMethods: [CAPPluginMethod] = [
        CAPPluginMethod(name: "initialize", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "setAnonymousIdentity", returnType: CAPPluginReturnPromise),
